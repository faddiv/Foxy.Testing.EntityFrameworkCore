...
namespace Foxy.Testing.EntityFrameworkCore
{
    public class OtherDbContext : DbContext
    {
        ...
        public virtual DbSet<CustomerCustomerDemo> CustomerCustomerDemo { get; private set; }

        public virtual DbSet<CustomerDemographics> CustomerDemographics { get; private set; }

        public virtual DbSet<Customers> Customers { get; private set; }

        public virtual DbSet<Employees> Employees { get; private set; }

        public virtual DbSet<EmployeeTerritories> EmployeeTerritories { get; private set; }

        public virtual DbSet<OrderDetails> OrderDetails { get; private set; }

        public virtual DbSet<Orders> Orders { get; private set; }

        public virtual DbSet<Products> Products { get; private set; }

        public virtual DbSet<Region> Region { get; private set; }

        public virtual DbSet<Shippers> Shippers { get; private set; }

        public virtual DbSet<Suppliers> Suppliers { get; private set; }

        public virtual DbSet<Territories> Territories { get; private set; }
